...
int main()
{
    ...
    LiteOCR::PaddleTextlineORI classifier;
    classifier.loadModel("./models/PP-LCNet_x0_25_textline_ori.param", "./models/PP-LCNet_x0_25_textline_ori.bin", LiteOCR::InferOption());
